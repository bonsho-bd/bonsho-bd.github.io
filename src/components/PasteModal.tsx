...
সন্তান, নাদিম রহমান`}
              ...
              <p className="text-emerald-800">
                💡 প্রতিটি ব্যক্তির তথ্য <strong>'নাম' (Name)</strong> দিয়ে শুরু করলেই স্বয়ংক্রিয়ভাবে নতুন ব্যক্তি তৈরি হবে, ফাঁকা লাইন রাখা বাধ্যতামূলক নয়। স্ত্রী/স্বামীর ঠিক নিচে সন্তানের নাম দিলে তারা সেই দম্পতির সন্তান হিসেবে যুক্ত হবে।
              </p>
            </div>
          )}
