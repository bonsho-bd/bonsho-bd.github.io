...
export const App: React.FC = () => {
  ...
  const handleSearchChange = (q: string) => {
    ...
    watermark.style.boxShadow = '0 4px 6px rgba(0,0,0,0.1)';
    ...
    try {
      ...
      // Inject watermark directly into the live visualizer
      const watermark = document.createElement('div');
      watermark.innerText = 'Generated by bonsho-bd.github.io';
      watermark.style.position = 'absolute';
      ...
      watermark.style.borderRadius = '12px';
      watermark.style.fontFamily = 'sans-serif';
      watermark.style.fontSize = '24px';
      watermark.style.color = '#333';
      watermark.style.fontWeight = 'bold';
      watermark.style.boxShadow = '0 10px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)';
      watermark.style.zIndex = '50';
      watermark.id = 'temp-watermark-full';
      visualizerRoot.appendChild(watermark);
      ...
      const qrEl = document.getElementById('temp-watermark-full');
      if (qrEl) qrEl.remove();
    }
  };
